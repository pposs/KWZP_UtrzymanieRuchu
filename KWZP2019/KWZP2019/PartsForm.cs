    ...
    public partial class PartsForm : Form
    {
        ...
        private void btnPanelSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (cbSearch.Text == "Nazwa części")
                {
                    ...
                    .Where(ps => ps.PartName.Contains(txtBoxSearch.Text)).ToList();
                ...
                {
                    dataPartsView.DataSource = db.vPartsViews
                    .Where(ps => ps.partType.Contains(txtBoxSearch.Text)).ToList();
                ...
                {
                    dataPartsView.DataSource = db.vPartsViews
                    .Where(ps => ps.Producer.Contains(txtBoxSearch.Text)).ToList();
        ...
        private void btnDeletePart_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Part part = new Part();
                    part = db.Parts.Where(t => t.PartName == selectedName).First();
